 ...
 * @author Hideki Ikeda
 */
public interface AuthenticationDeviceProcessor
{
    /**
     * Process communication between the authorization server and the authentication
     * device for end-user authentication and authorization.
     */
    void process();
}
